...
const Register = () => {
  ...
  const notify4 = () =>
    toast.error("Car registration number already exist", {
      containerId: "container3",
    });
  ...
  // state controls for terms&c, privacy open and close
  const [openedt, setOpenedt] = useState(false);
  const [openedp, setOpenedp] = useState(false);

  const { showFirstForm, showSecondForm, setShowFirstForm, setShowSecondForm } =
    useFormContext();
  ...
  useEffect(() => {
    ...
    if (storedDob) {
      ...
      setDate(
        `${storedDob.slice(0, 2)}/${storedDob.slice(2, 4)}/${storedDob.slice(
          4,
          8
        )}`
      );
  ...
  function isFormFilled(formData) {
    const { full_name, email, address, mobile, dob, gender, city } = formData;
    // return (
    //   full_name.trim() !== "" &&
    //   email.trim() !== "" &&
    //   mobile.length !== "" &&
  ...
  const progressBarStyle = {
    // width: '400px',
    width:
      showFirstForm === true ? "50%" : showSecondForm === true ? "100%" : "0",
    background:
      "linear-gradient(to bottom, rgba(0, 122, 255, 1) 0%, rgba(0, 66, 137, 1) 50%, rgba(0, 25, 52, 1) 100%)",
  ...
  useEffect(() => {
    ...
    const storedCheckboxState = JSON.parse(
  ...
  useEffect(() => {
    const storedCarRegistrationNumber = localStorage.getItem(
  ...
  // before background image loading, control whitespace
          ...
          <div className={css.relativediv}>
            <div className={css.rotate}>
              <div className={css.rotatehead}>
                <span
                  className={showFirstForm ? css.p1 : css.p2}
                  onClick={() => {
                    setShowFirstForm(true);
                    setShowSecondForm(false);
                  }}
                ...
                <span className={showSecondForm ? css.c1 : css.c2}>
                  car & social info
                </span>
              </div>
            ...
            <div className={css.formdiv}>
              ...
              {showFirstForm && (
                ...
                >
                  ...
                  <div
                    className={`${css.inputset} ${
                      formData.number ? css.hasContent : ""
                    }`}
                  >
                    <input
                      name="number"
                  ...
                  <div
                    className={`${css.inputset} ${date ? css.hasContent : ""}`}
                  >
                    <input
                      name="dob"
                      value={date}
                  ...
                  <div className={css.inputset}>
                      ...
                      style={{
                        color:
                          formData.gender === ""
                            ...
                            ? "#fff" // Replace with the desired color
                    ...
                    >
                      <option
                        className={`${css.opt} ${css.optgender}`}
                        value=""
                      >
                        {" "}
                        Gender
                    ...
                    <select
                      ...
                      style={{
                        color:
                          formData.city === ""
                            ? "#666"
                            : formData.city === "Andrapradesh"
                            ? "#fff"
                            : formData.city === "Karnataka"
                            ? "#fff"
                            : formData.city === "Kerala"
                            ? "#fff"
                            : formData.city === "TamilNadu"
                            ? "#fff"
                            : formData.city === "Telangana"
                            ? "#fff"
                            : "#666", // Default color
                      }}
                    >
                ...
                <form className={css.form2} action="" onSubmit={sendEmail2}>
                  <div className={css.form2top}>
                    <div className={css.carinputset}>
                      ...
                      <div className={css.descript}>
                        <span>
                          Your membership will cover one car. You can add more
                          cars later in the Batcave Mobile App.
                        </span>{" "}
                      </div>
                    </div>

                    <div
                      className={`${css.carinputsets} ${
                        carData.registrationNumber ? css.hasContent : ""
                      }`}
                    >
                      <div
                        className={
                          !isChecked ? css.regnumbboxinactive : css.regnumbbox
                        }
                      >
                        <input
                        ...
                        <label className={css.label}>
                          <span
                            className={`${css.char} ${css.forfade}`}
                            style={{ transitionDelay: "00ms" }}
                          >
                            C
                          </span>
                      ...
                      <div className={css.dummy}>
                        <span
                          className={
                            !isChecked ? css.dummyspanfade : css.dummyspan
                          }
                        >
                          Should be a max of 10 digits(TN05YY1234)
                        </span>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <label
                        className={`${css.label} ${
                          isFocused || inputValue ? css.labelFocused : ""
                        }`}
                      >
                        <span
                          className={css.char}
                  ...
                  <div className={css.form2bottom}>
                    ...
                    <button
                      ...
                      type="submit"
                      className={`${css.proceedbtn} ${css.buttonWithZIndex}`}
                    >
                      {" "}
                      proceed to checkout
                    </button>
      ...
      {openedt && (
        ...
        >
          ...
          <div className={css.content}>
            <span className={css.thead}>
              Batcave Membership Terms and Conditions
            </span>
            <span className={css.tcontent}>
              These terms and conditions ("Terms") govern your membership with
              Batcave ("Club"). By registering and becoming a member, you agree
              to comply with these Terms. Please read them carefully.
            </span>
            <span className={css.thead}>1. Membership Eligibility:</span>
            <span className={css.tcontent}>
              - Membership is open to individuals who meet the Club's criteria.
            </span>
            <span className={css.tcontent}>
            ...
            <span className={css.tcontent}>
              - Members gain access to exclusive Club events, discounts, and
              privileges as outlined by the Club.
            </span>
            <span className={css.tcontent}>
              - Benefits may be subject to change at the discretion of the Club.
            </span>
            <span className={css.thead}>3. Membership Duration:</span>
            <span className={css.tcontent}>
              - Membership duration for Batcave OGs is Lifetime from the date of
              registration.
            </span>
            <span className={css.tcontent}>
              - Memberships are only transferable to the heir for the holder and
              attract a nominal transfer fee.
            </span>
            <span className={css.thead}>4. Registration and Fees:</span>
            <span className={css.tcontent}>
              - Membership registration requires payment of the specified fee.
            </span>
            <span className={css.tcontent}>
            ...
            <span className={css.tcontent}>
              - Members must adhere to the Club's code of conduct during Club
              events and interactions.
            </span>
            <span className={css.tcontent}>
              - Inappropriate behaviour may result in membership termination.
            </span>
            <span className={css.thead}>6. Privacy and Data:</span>
            <span className={css.tcontent}>
              - The Club will handle your personal information in accordance
              with its privacy policy.
            </span>
            <span className={css.tcontent}>
              - Your information may be used for Club communications and
              promotions.
            </span>
            <span className={css.thead}>7. Termination:</span>
            <span className={css.tcontent}>
              - The Club reserves the right to terminate or suspend a membership
              for violation of these Terms or any disruptive behaviour.
            </span>
            <span className={css.thead}>8. Disclaimers:</span>
            <span className={css.tcontent}>
              - The Club is not responsible for any accidents, damage, or loss
              that may occur during Club events.
            </span>
            <span className={css.tcontent}>
              - Members are responsible for their own safety and the safety of
              their property.
            </span>
            <span className={css.thead}>9. Changes to Terms:</span>
            <span className={css.tcontent}>
              - The Club may modify these Terms at any time. Members will be
              notified of changes.
            </span>
            <span className={css.thead}>
            ...
            <span className={css.tcontent}>
              - These Terms are governed by the laws of the State of Tamil Nadu,
              India.
            </span>
            <span className={css.tcontent}>
              - Any disputes or legal proceedings arising from these Terms will
              be subject to the exclusive jurisdiction of the courts located in
              Coimbatore, Tamil Nadu, India.
            </span>
            �
            <span className={css.tcontent}>
              By registering for Batcave OGs membership, you acknowledge that
      ...
      {openedp && (
        ...
        >
          ...
          <div className={css.content}>
            ...
            <span className={css.pcontent}>
              Welcome to Batcave ("Club"). This Privacy Policy outlines how we
              collect, use, and protect your personal information. By becoming a
              member of our club, you agree to the terms and practices described
              in this policy.
            </span>
            ...
            <span className={css.pcontent}>
              - Membership Information: Details related to your membership,
              including payment information and details relevant to your car.
            </span>
            <span className={css.pcontent}>
              - Communication Preferences: Your preferences for receiving
              communications from the Club.
            </span>
            <span className={css.pcontent}>
              - Event Participation: Information related to your participation
            ...
            <span className={css.pcontent}>
              - To manage and administer your club membership.
            </span>
            <span className={css.pcontent}>
              - To communicate with you about club events, news, and updates.
            </span>
            <span className={css.pcontent}>
              - To personalise your club experience.
            </span>
            <span className={css.pcontent}>
              - To process payments for membership fees and event registrations.
            </span>
            <span className={css.pcontent}>
            ...
            <span className={css.pcontent}>
              You can update your communication preferences or request the
              deletion of your personal information by contacting us at
              support@batcave.co.in.
            </span>
            ...
            <span className={css.pcontent}>
              ...
              practices. The revised policy will be effective from the date
            ...
            <span className={css.pcontent}>
              ...
              data practices, please contact us at support@batcave.co.in.
            </span>
          </div>
        </motion.div>
      )}

      {/* dummy buttons for toast */}
      <button className={css.bt1} onClick={notify1}>
        Show Toast 1
      </button>
      <button className={css.bt2} onClick={notify2}>
        Show Toast 2
      </button>
      <button className={css.bt3} onClick={notify3}>
        Show Toast 3
      </button>
      <button className={css.bt4} onClick={notify4}>
        Show Toast 4
      </button>

      <ToastContainer
        className={css.customtoastcontainer}
