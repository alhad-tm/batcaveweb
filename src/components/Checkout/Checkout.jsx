...
const Checkout = () => {
  ...
  //  state control for refund,shipping open close
      ...
      <div className={css.wrap}>
        ...
        <div className={css.wbottom}>
            ...
            <div className={css.checkoutform}>
              ...
              <div className={css.inputset}>
                ...
                <div className={css.checkboxdiv}>
                  ...
                  <input type="checkbox" id="cbx" className={css.cbx} />
                  <label htmlFor="cbx" className={css.check}>
                    <svg width="18px" height="18px" viewBox="0 0 18 18">
                      <path d="M1,9 L1,3.5 C1,2 2,1 3.5,1 L14.5,1 C16,1 17,2 17,3.5 L17,14.5 C17,16 16,17 14.5,17 L3.5,17 C2,17 1,16 1,14.5 L1,9 Z"></path>
                      <polyline points="1 9 7 14 15 4"></polyline>
                    </svg>
                  </label>
                  <p className={css.shippinglabel} htmlFor="">
                    My shipping address same as my residential address
                  </p>
                </div>
                  ...
                  <div className={css.applydiv}>
                    ...
                    <img
                      className={`${css.tickImage} ${
                        inputValueApply ? css.showImage : css.hideImage
                      }`}
                      src={Tick}
                      alt=""
                    />
          ...
          <div className={css.right}>
            ...
            <span className={css.agreespan}>
              by clicking, I AGREE WITH THE{" "}
              <span
                onClick={() => setOpened(!opened)}
                className={css.spaninside}
              >
                refund policy{" "}
              </span>{" "}
              &{" "}
            ...
            <button onClick={notify} className={css.proceedbtn}>
              PROCEED TO PAY
            </button>
          </div>
        </div>
      ...
      {opened && (
        ...
        >
          ...
          <div className={css.content}>
            ...
            <span className={css.rcontent}>
              At Batcave OGs, we value your membership and your commitment to
              our community of car enthusiasts. However, please note that all
              membership fees are non-refundable. We do not offer refunds for
              membership payments under any circumstances.
            </span>

            <span className={css.rhead}>Event Registration Refunds:</span>
            <span className={css.rcontent}>
              For events and activities organised by Batcave OGs, event
              registration fees may be eligible for refunds, subject to the
              following conditions:
            </span>

            <span className={css.rcontent1}>
              - Full Refund: Cancellations made 3 days or more before the event
              start date.
            </span>
            <span className={css.rcontent1}>
              - Partial Refund: Cancellations made within 3 days before the
              event start date, subject to a 40% cancellation fee.
            </span>
            <span className={css.rcontent1}>
              - No Refund: Cancellations made on or after the event start date.
            </span>

            <span className={css.rhead}>Refund Process:</span>

            <span className={css.rcontent}>
              To request a refund for an event or activity, please contact us at
              refunds@batcave.co.in. Refunds will be processed within 5-7
              business days, and the amount refunded will be based on the above
            ...
            <span className={css.rcontent}>
              ...
              <a href="mailto: support@batcave.co.in.">
      ...
      {sopened && (
        ...
        >
          ...
          <div className={css.content}>
            ...
            <span className={css.scontent}>
              Batcave OGs ("Club") offers shipping services for specific
              products, merchandise, or promotional items. Shipping may be
              available to locations within [list the specific regions or
              countries where you offer shipping].{" "}
            </span>

            <span className={css.shead}> 2. Shipping Methods: </span>

            <span className={css.scontent1}>
              {" "}
            ...
            <span className={css.scontent1}>
              {" "}
              - Orders are typically processed and shipped within 7-10 business
              days.
            </span>
            <span className={css.scontent1}>
              {" "}
            ...
            <span className={css.scontent1}>
              ...
              destination of your order. The exact shipping cost will be
            ...
            <span className={css.scontent1}>
              {" "}
              Delivery times may vary depending on the shipping method selected
              and the destination. Estimated delivery times are provided for
              each shipping method, but please note that these are approximate
              and not guaranteed.{" "}
            </span>

            <span className={css.shead}>6. International Shipping:</span>
            <span className={css.scontent1}>
              For international orders, please be aware of any import duties,
              taxes, or customs fees that may be applicable in your country.
            ...
            <span className={css.scontent1}>
              {" "}
              In the event of a lost or damaged shipment, please contact us at
              support@batcave.co.in as soon as possible. We will work with the
            ...
            <span className={css.scontent1}>
              ...
              information provided in your order confirmation email.{" "}
            </span>
            ...
            <span className={css.scontent1}>
              ...
              please contact us at support@batcave.co.in.{" "}
            </span>
          </div>
        </motion.div>
      )}
